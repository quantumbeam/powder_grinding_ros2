...
import rclpy
from rclpy.logging.LoggingSeverity import LoggingSeverity
from rclpy.clock import Clock, ClockType


def load_urdf_string(package, file_path):
    urdf = None
...
class PDRotation:
    ...
    def reset(self):
        self.last_time = Clock(clock_type=ClockType.ROS_TIME).now()
...
class TextColors:
    ...
    def logdebug(self, msg):
        ...
        @param msg: the message to be printed.
        """
        if self.log_level <= LoggingSeverity.DEBUG:
    ...
    def loginfo(self, msg):
        ...
        @param msg: the message to be printed.
        """
        if self.log_level <= LoggingSeverity.INFO:
            print(("INFO " + str(msg)))
    ...
    def logwarn(self, msg):
        ...
        @param msg: the message to be printed.
        """
        if self.log_level <= LoggingSeverity.WARN:
    ...
    def logerr(self, msg):
        ...
        @param msg: the message to be printed.
        """
        if self.log_level <= LoggingSeverity.ERROR:
    ...
    def logfatal(self, msg):
        ...
        @param msg: the message to be printed.
        """
        if self.log_level <= LoggingSeverity.FATAL:
